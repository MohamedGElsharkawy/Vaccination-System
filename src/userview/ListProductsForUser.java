 ...
 * @author Camatcho
 */
public class ListProductsForUser extends javax.swing.JFrame {

    /**
     * Creates new form display
     */
    public ListProductsForUser() {
        initComponents();
        addRowsTojTable();
    }
 ...
 public void addRowsTojTable() {
        ...
        products = product.displayAllVacc();

        for (Product x : products) {
            rowData[0] = x.getVacc_Name();
            rowData[1] = x.getVacc_Price();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListProductsForUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ListProductsForUser().setVisible(true);
        });
    }
