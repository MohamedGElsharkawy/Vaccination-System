...
public class cancelReservation extends javax.swing.JFrame {
    ...
    private void btnlogin2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnlogin2ActionPerformed
       if (!search.getText().equals("")) {
            ...
            product.setVacc_Name(search.getText());
            product.setVacc_Price(Double.parseDouble(price.getText()));
             product.setDate(date.getText());
            product.setTime(Integer.parseInt(time.getText()));
            
            if (product.addVacc()){
            JOptionPane.showMessageDialog(null,"the Reservation Canceled");
          Reservation x = new Reservation();
           x.deleteRes(search.getText());
        resetPanelData();
            } else {
        ...
        JOptionPane.showMessageDialog(null,"Complete the fields");
          ...
          JOptionPane.showMessageDialog(null,"Check If Vaccination is Reserved in System");
