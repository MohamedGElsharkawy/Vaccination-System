...
public class show extends javax.swing.JFrame {
    ...
    public void addRowsTojTable(){
        ...
        feedbacks= f.listFeedback();
        for(feedback x : feedbacks){
            rowData[0]=x.feedbackID;
            rowData[1]=c.getemail();
            rowData[2]=x.getVeryGood();
            rowData[3]=x.getGood();
            rowData[4]=x.getNormal();
            rowData[5]=x.getBad();
            rowData[6]=x.getVeryBad();
            rowData[7]=x.getMessage();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "email", "verygood", "good", "normal", "bad", "verybad", "message"
            }
        ));
